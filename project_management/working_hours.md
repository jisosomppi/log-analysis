...
|wk 45|26|13|5|Jussi created local repository for specific version of Elastic products + made it usable with Salt. Eino got tls encryption working with some dodgy file permissions.|
